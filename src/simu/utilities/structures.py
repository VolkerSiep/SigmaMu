...
class ParameterDictionary(dict):
    ...
    def register_vector(self, key: str, sub_keys: list[str], unit: str):
    ...
    def register_sparse_matrix(self, key: str, pairs: dict, unit: str):
        ...
        applied.
            ...
            >>> pdict = ParameterDictionary()
            >>> pairs = [("H2O", "CO2"), ("H2O", "CH4")]
            >>> from pprint import pprint
            >>> pprint(pdict.register_sparse_matrix("K_ij", pairs, "K"))
    ...
    def get_vector_quantity(self, *keys):
        ...
        .. todo::
            This is very risky with respect to sequence!!!
