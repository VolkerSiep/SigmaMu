...
from simu.examples.nacl_parameter_fit.common import define_models, load_definition
from simu.examples.nacl_parameter_fit.thermo import thermo_store
...
def main():
    ...
    solver = ThermoFitSolver(models, thermo_store.get_source("Pitzer"))
